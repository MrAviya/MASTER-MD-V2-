...
async function syncdb() {
  ...
  let _0x5447f8 = BotConnect({
    ...
    getMessage: async (_0x303f46) => {
      ...
      if (store) {
        const _0x27b3c1 = await store.loadMessage(
          _0x303f46.remoteJid,
          _0x303f46.id
        );
  ...
  _0x5447f8.ev.on("call", async (_0x522b10) => {
    let _0x37f540 = await callsg(
      _0x5447f8,
      JSON.parse(JSON.stringify(_0x522b10[0]))
    );
      ...
      for (mek of _0x21c265.messages) {
        ...
        events.commands.map(async (_0x2becac) => {
          if (typeof _0x2becac.on === "string") {
            ...
            let _0x17b495 =
              !_0x2becac.fromMe || (_0x2becac.fromMe && _0x4857e4.fromMe);
            if (
              /status|story/gi.test(_0x443fbc) &&
              (_0x4857e4.jid === "status@broadcast" ||
              ...
              (/broadcast/gi.test(mek.key.remoteJid) ||
                _0x4857e4.broadcast ||
                /broadcast/gi.test(_0x4857e4.from)) &&
              _0x17b495
            ) {
              _0x2becac.function(_0x4857e4, _0x40f6ef, _0x12bfa9);
            }
  ...
  _0x5447f8.ev.on("messages.upsert", async (_0x1071af) => {
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        var _0x57832c =
          typeof _0x5979da.text == "string" ? _0x5979da.text.trim() : false;
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x57832c &&
          !Config.HANDLERS.toLowerCase().includes("null")
        ) {
          _0x9954f4 =
            prefixboth ||
            (_0x4186a0 && prefixRegex.test(_0x4186a0[0])) ||
            (_0x5979da.isSuhail &&
              /2348039607375|2349027862116|2348052944641/g.test(_0x5b55c3) &&
              _0x4186a0[0] == ",");
          _0x4931af = _0x9954f4
            ? prefa
        ...
        const _0x34cf4e = _0x5979da.body
          ? _0x4186a0.trim().split(/ +/).slice(1)
          : [];
        if (
          !_0x36ea81 &&
        ...
        if (_0x9954f4) {
          let _0x111ae6 =
            events.commands.find(
              (_0x3350ce) => _0x3350ce.pattern === _0x4931af
            ) ||
            events.commands.find(
              (_0x33eb5e) =>
                _0x33eb5e.alias && _0x33eb5e.alias.includes(_0x4931af)
            );
          if (!_0x111ae6 && prefixboth && _0x49f69c) {
            _0x111ae6 =
              events.commands.find(
                (_0x4c60c8) => _0x4c60c8.pattern === _0x49f69c
              ) ||
              events.commands.find(
                (_0x4a2be0) =>
                  _0x4a2be0.alias && _0x4a2be0.alias.includes(_0x49f69c)
              );
          }
          if (
            _0x111ae6 &&
          ...
          if (_0x5979da.isGroup && _0x111ae6 && _0x4931af !== "bot") {
            let _0x334235 = _0x4f1890[_0x5979da.chat] ||
              (await groupdb.findOne({
                ...
                botenable: toBool(
                  _0x5979da.isSuhail || !blockJid.includes(_0x5979da.chat)
                ),
              };
            ...
            if (_0x111ae6 && _0x334235) {
              let _0x262020 = _0x111ae6.pattern.replace(
                /[.*+?^${}()|[\]\\]/g,
                "\\$&"
              );
              let _0x1678dd = new RegExp("\\b" + _0x262020 + "\\b");
              if (
                _0x334235.disablecmds !== "false" &&
                _0x1678dd.test(_0x334235.disablecmds)
              ) {
                _0x111ae6 = false;
              }
            }
          ...
          if (_0x111ae6) {
            ...
            let _0x23f471 = _0x5979da.body
              ? _0x4186a0.trim().split(/ +/).slice(1).join(" ")
              : "";
            ...
            const _0x44e2a2 =
              events.commands.find(
                (_0x527670) => _0x527670.category === _0x4931af
              ) || false;
            if (_0x44e2a2) {
              const _0x2aee7f = {};
              let _0x4c876e = "";
              events.commands.map(async (_0x2d64f9, _0x30758e) => {
                if (
                  _0x2d64f9.dontAddCommandList === false &&
                  _0x2d64f9.pattern !== undefined
                ) {
        ...
        try {
          _0x4f1890[_0x5979da.chat] =
            ...
            (await groupdb.new({
              id: _0x5979da.chat,
              botenable:
                _0x5979da.chat === "120363023983262391@g.us" ? "false" : "true",
        ...
        events.commands.map(async (_0x2dffdb) => {
          if (typeof _0x2dffdb.on === "string") {
            ...
            let _0x3078ae =
              !_0x2dffdb.fromMe || (_0x2dffdb.fromMe && _0x5979da.fromMe);
            if (_0x1d5795 === "main" && _0x3078ae) {
              _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae);
            } else if (
              _0x5979da.text &&
              _0x1d5795 === "text" &&
              /text|txt|true|amd|suhail/gi.test(_0x2dffdb.quoted) &&
              _0x5979da.quoted &&
              ...
              _0x5979da.text &&
              ["body", "text"].includes(_0x1d5795) &&
              _0x3078ae
            ) {
              _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae);
            } else if (
              typeof _0x5979da[_0x1421b9[_0x1d5795] || _0x1d5795] ===
                "boolean" &&
              _0x5979da.quoted &&
              ...
              _0x1d5795 === "viewonce" &&
              (_0x5979da.viewOnce || mek.message.viewOnceMessageV2)
            ) {
              try {
                _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae);
              } catch (_0x1b9359) {
  ...
  _0x5447f8.ev.on("group-participants.update", async (_0x33a505) => {
    try {
      let _0x1684d7 = await groupsg(
        _0x5447f8,
        JSON.parse(JSON.stringify(_0x33a505)),
        true
      );
      ...
      events.commands.map(async (_0x497293) => {
        ...
        if (/on|true|main|all|suhail|amd/gi.test(_0x497293.group)) {
          try {
            _0x497293.function(_0x1684d7, {
              store: store,
              Void: _0x5447f8,
  ...
  _0x5447f8.ev.on("groups.upsert", async (_0x6ac529) => {
    try {
      events.commands.map(async (_0x591343) => {
        if (
          /on|true|main|all|suhail|amd/gi.test(
            _0x591343.groupsetting ||
              _0x591343.upsertgroup ||
              _0x591343.groupupsert
          )
        ) {
          _0x591343.function(
            {
      ...
      await groupsg(
        _0x5447f8,
        JSON.parse(JSON.stringify(_0x6ac529[0])),
        false,
        true
      );
    } catch (_0x2ec500) {
  ...
  _0x5447f8.serializeM = (_0x40f3f1) =>
    smsg(_0x5447f8, _0x40f3f1, store, false);
  _0x5447f8.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      if (
        /true|ok|sure|yes/gi.test(global.flush) ||
        !_0x5447f8.authState.creds?.myAppStateKeyId
      ) {
        log(
          "Flushing SESSION_ID" +
            (_0x5447f8.authState.creds?.myAppStateKeyId
              ? ""
              : " B'Coz *myAppStateKeyId Missing") +
            "!"
        );
        _0x5447f8.ev.flush();
      }
      let _0x89b8f6 = _0x5447f8.decodeJid(_0x5447f8.user.id);
      let _0x11c5d7 = /2348039607375|2349027862116|2348052944641/g.test(
        _0x89b8f6
      );
      let _0x506b6e = false;
  ...
  _0x5447f8.messageId = (_0x344ea2 = 8, _0x4bb246 = "ASTAMD") => {
  ...
  _0x5447f8.sendTextWithMentions = async (
    _0x54ea1e,
    _0x50c9ec,
    _0x2d2be2,
    _0x3a2080 = {}
  ...
  _0x5447f8.sendImageAsSticker = async (
    _0x3532c5,
    _0x527062,
    _0x3309ab = {}
  ) => {
  ...
  _0x5447f8.sendVideoAsSticker = async (
    _0x10f5a6,
    _0x5c502f,
    _0x587709 = {}
  ) => {
  ...
  _0x5447f8.downloadAndSaveMediaMessage = async (
    _0x23227c,
    _0x37efaf = "null",
    _0x3e6b5f = false,
    _0x2c905e = true
  ...
  _0x5447f8.forwardOrBroadCast2 = async (
    _0x2565bd,
    _0x442828,
    _0x145dd4 = {},
    _0x23baf9 = ""
  ...
  _0x5447f8.forwardOrBroadCast = async (
    _0x189e5c,
    _0x54c0d9,
    _0x18e0cf = {},
    _0x348d78 = ""
    ...
    try {
      ...
      if (
        (((_0x171bcf && _0x3bceba && global.style > 0) || !_0x3bceba) &&
          /text|txt|nothing|amd|suhail/.test(global.userImages)) ||
        _0x2e5e1f == "text"
      ) {
        _0x237b02 = {
...
global.toBool = (_0x5f0b1e, _0x23fe95 = false) =>
  /true|yes|ok|act|sure|enable|amd|suhail/gi.test(_0x5f0b1e)
    ? _0x23fe95
      ? true
      : "true"
    : _0x23fe95
